...
namespace Tadmor.Services.E621
{
    ...
    public class E621Service
    {
        ...
        public static readonly HashSet<string> PokemonNameTags = ToHashSetExtension.ToHashSet(PokemonNameTagsString
            .Split(", ")
            .Select(s => s.Replace("pokémon_", string.Empty).Replace("_(pokémon)", string.Empty)), StringComparer.OrdinalIgnoreCase);
        ...
        public async Task<E621Post> SearchRandom(string tags)
        {
            ...
            return posts.Any() ? MoreEnumerable.RandomSubset(posts, 1).Single() : throw new Exception("no results");
        }
